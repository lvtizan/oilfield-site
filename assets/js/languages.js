  ...
  var PACK = {
    en: {
      ui: {
        ...
        'home.p1.tagA': 'Power',
        'home.p1.tagB': '· wellsite / power plant / standby',
        'home.p2.tag': 'Mining / drilling power · long-duty in high-altitude & extreme-cold conditions',
    ...
    ru: {
      ui: {
        ...
        'home.p1.tagB': '· куст скважин / электростанция / резерв',
        'home.p2.tag': 'Горная добыча / буровая мощность · длительная работа на высоте и в сильный мороз',
    ...
    zh: {
      ui: {
        ...
        'home.p1.tagA': '功率',
        'home.p1.tagB': '· 井场 / 电站 / 备用',
        'home.p2.tag': '矿用 / 钻井动力 · 高原与极寒长时工况',
