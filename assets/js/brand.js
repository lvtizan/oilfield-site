...
(function (window, document) {
  ...
  if (!document.getElementById('kst-brand-css')) {
    ...
    css.textContent = [
      ...
      "site-header[transparent] .ksth:not(.solid) .ksth-search{background:rgba(255,255,255,.24);border-color:rgba(255,255,255,.42);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-search:focus-within{border-color:rgba(255,255,255,.68);background:rgba(255,255,255,.34)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-search svg{stroke:rgba(22,31,39,.62)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-search input{color:rgba(18,26,33,.82)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-search input::placeholder{color:rgba(18,26,33,.50)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-lang button{color:rgba(18,26,33,.58);text-shadow:0 1px 1px rgba(255,255,255,.34)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-lang button[aria-pressed='true']{color:rgba(18,26,33,.88);background:rgba(255,255,255,.34);box-shadow:inset 0 0 0 1px rgba(255,255,255,.22)}",
