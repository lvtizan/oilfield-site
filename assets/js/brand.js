...
(function (window, document) {
  ...
  if (!document.getElementById('kst-brand-css')) {
    ...
    css.textContent = [
      ...
      "site-logo .logo .sub{font-family:'Barlow Condensed','Arial Narrow',sans-serif;font-size:10.5px;letter-spacing:.146em;color:#fff;white-space:nowrap;text-shadow:0 1px 1px rgba(0,0,0,.24)}",
      ...
      "site-header[transparent] .ksth:not(.solid) .ksth-search{background:rgba(255,255,255,.18);border-color:rgba(255,255,255,.58);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-search:focus-within{border-color:rgba(255,255,255,.82);background:rgba(255,255,255,.26)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-search svg{stroke:rgba(255,255,255,.88)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-search input{color:#fff;text-shadow:0 1px 1px rgba(0,0,0,.20)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-search input::placeholder{color:rgba(255,255,255,.70)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-lang button{color:rgba(255,255,255,.66);text-shadow:0 1px 1px rgba(0,0,0,.20)}",
      "site-header[transparent] .ksth:not(.solid) .ksth-lang button[aria-pressed='true']{color:#fff;background:rgba(255,255,255,.22);box-shadow:inset 0 0 0 1px rgba(255,255,255,.18)}",
